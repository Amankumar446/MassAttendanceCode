      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="text-center md:text-left mb-4 md:mb-0 py-4">
          ...
          <div className="flex items-center justify-center md:justify-start space-x-2">
            ...
            <span className="text-white">+91 92583 60736</span>
          </div>

          <div className="flex items-center justify-center md:justify-start space-x-2">
            <FontAwesomeIcon icon={faEnvelope} className="text-white" />
            <span className="text-white">registrar@dsvv.ac.in</span>
          </div>
        </div>

        <div className="text-center">
          <p className="text-white">© 2024 Auto Attendance Portal. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
